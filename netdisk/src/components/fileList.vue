          ...
          <el-menu
            ...
            <el-submenu index="1">
              ...
              <el-menu-item-group>
                ...
                <el-menu-item index="1-3" style="font-size: 20px;">
                  <div class="menu-item-content">
                    <i class="el-icon-video-play"></i>
                    <span>视 频</span>
                  </div>
                </el-menu-item>
                <el-menu-item index="1-4" style="font-size: 20px;">
                  <div class="menu-item-content">
                    <i class="el-icon-headset"></i>
                    <span>音 频</span>
                  </div>
                </el-menu-item>
                <el-menu-item index="1-5" style="font-size: 20px;">
                  <div class="menu-item-content">
                    <i class="el-icon-more"></i>
                    <span>其 他</span>
                  </div>
                </el-menu-item>
                <el-menu-item index="1-6" style="font-size: 20px;">
                  <div class="menu-item-content">
...
<script>
import { createDir, deleteFile, getFile, renameFile } from '@/api/file'
  ...
  methods: {
    ...
    pasteClipboard () {
      ...
      if (this.clipboard.action === 'cut') {
        axios.put('http://8.134.178.176:8080/file/move?mode=1', requestData, {
          headers: { Authorization: this.$store.state.usertoken }
        })
          .then(response => {
            console.log('Paste successful:', response.data)
